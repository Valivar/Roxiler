...
we can add multiple user, add ownwer, shop and all.. real website

T web application that allows users to submit ratings for stores registered on the
